...
public class BuyingAdapter extends ArrayAdapter<BuyingCategoryBean>{
	
	private ArrayList<BuyingCategoryBean> arr= new ArrayList<BuyingCategoryBean>();
	private ViewHolder mHolder;
	private ImageLoader imageLoader;
	private Activity activity;	
	private IBase iBase ;
	
	public BuyingAdapter(Activity activity, int textViewResourceId, ArrayList<BuyingCategoryBean> items) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		imageLoader.DisplayImage(arr.get(position).getmBuyingCategoryImage(), R.drawable.loader, mHolder.each_image);
	
		mHolder.tv_each_item.setText(arr.get(position).getmBuyingCategoryName());
		...
		mHolder.rl_full.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				iBase.goBuyingFragmentItem(arr.get(position).getmBuyingCategoryId(),arr.get(position).getmBuyingCategoryName());
			}
		});
